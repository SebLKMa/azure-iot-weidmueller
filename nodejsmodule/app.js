...
//
// Using the Azure CLI:
// az iot hub device-identity connection-string show --hub-name <hubname> --device-id weidmueller-model-x --output table
var connectionString = 'HostName=<hubname>.azure-devices.net;DeviceId=weidmueller-model-x;SharedAccessKey=...';
